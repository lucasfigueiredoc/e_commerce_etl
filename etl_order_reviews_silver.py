...
nome_arquivo_bronze = "olist/olist_order_reviews_dataset.csv"
nome_arquivo_silver = "olist/olist_order_reviews_dataset.parquet"
...
caminho_local_parquet = os.path.join(PASTA_LOCAL_TEMP, "olist_order_reviews_dataset.parquet")
