...
nome_arquivo_bronze = "olist/olist_customers_dataset.csv"
nome_arquivo_silver = "olist/olist_customers_dataset.parquet"
...
df_customer = pd.read_csv(resposta)
resposta.close()
resposta.release_conn()

# --- 4. GUARDAR E ENVIAR PARA A CAMADA SILVER ---
caminho_local_parquet = os.path.join(PASTA_LOCAL_TEMP, "olist_customers_dataset.parquet")
...
df_customer.to_parquet(caminho_local_parquet, index=False)
